...
const Navbar = (props) => {
    ...
    return (
       <nav className="sticky top-4 rounded-xl z-40 flex flex-row flex-wrap justify-center bg-primary rounded-xl">
        ...
        justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 
        dark:!bg-navy-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2 xl:mt-[20px]">
            ...
            <span
                className="flex cursor-pointer text-x1 xl:hidden"
